...
CREATE TABLE `medication_review_session` (
  ...
  KEY `CompositeMedReview` (`Patient_ID`,`Drug_ID`,`Session_Date`),
  KEY `Drug_ID` (`Drug_ID`),
  CONSTRAINT `medication_review_session_ibfk_1` FOREIGN KEY (`Patient_ID`) REFERENCES `patients` (`Patient_ID`),
  CONSTRAINT `medication_review_session_ibfk_2` FOREIGN KEY (`Drug_ID`) REFERENCES `drug` (`Drug_Id`)

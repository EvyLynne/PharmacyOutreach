...
(
  ...
  `Post_Session_Level_Of_Confidence_Blood_Sugar` varchar(255),
  `Post_Session_Level_Of_Confidence_Weight_Control` varchar(255),
  `Post_Session_Level_Of_Confidence_Medication` varchar(255),
  `Post_Session_Level_Of_Confidence_Exercise` varchar(255),
...
ALTER TABLE `Medication_Related_Problem` ADD FOREIGN KEY (`Drug_ID`) REFERENCES `Drug` (`Drug_Id`);
